...
<head>
    ...
    <style>
        #pendukung {
            background-color: rgba(255, 255, 142, 0.282);
        }

        #at_info {
            background-color: rgba(142, 246, 255, 0.282);
        }

        #at_target {
            background-color: rgba(174, 142, 255, 0.277);
        }
    </style>
    <!-- CUSTOM CSS -->
</head>
                            ...
                            <div class="col-lg-12 mb-4 order-0">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title text-primary">INISIAL PROSES</h5>
                                    </div>
                                    <hr>
                                    <div class="card-body">
                                        <div class="table-responsive table-border text-nowrap" id="tableContainer">
                                            <table class="table" id="dataTable">
                                                <thead>
                                                    <tr class="text-center">
                                                        <th class="bg-info text-white ">Atribut Info</th>
                                                        <th class="bg-warning text-white " colspan="4">Atribut Pendukung
                                                        </th>
                                                        <th class="bg-primary text-white ">Label Target</th>
                                                    </tr>
                                                </thead>
                                                <thead>
                                                    <tr class="text-center">
                            ...
                            <script>
                                ...
                                if (jsonData) {
                                    ...
                                    for (var i = 0; i < jsonData[0].length; i++) {
                                        htmlTable += '<th class="text-dark">' + jsonData[0][i] + '</th>';
                                    }
                                    htmlTable += '</tr>';
                                    htmlTable += '</thead>';
